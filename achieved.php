...
<div class="list">
	<table class="title-table">
		<td id="d"> DATA </td> <td id="i"> IP </td>  <td id="l"> LINK </td>  <td id="c"> CODE </td>
	</table>
...
<?php
 ...
 $L = $mysqli->query("SELECT ip,data,link,code FROM ips_achieved WHERE usuario='$usr'");
 ...
 while($dados = mysqli_fetch_array($L)){
    ...
    echo "\t".'<td>'.$dados['data'].'<td/>'.$dados['ip'].'<td/>'.$dados['link'].'<td/>'.$dados['code'].'<td/><a href="#">X</a><tr/>'."\n\n";
